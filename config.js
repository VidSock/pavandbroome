module.exports = {
  siteTitle: 'Pav & Broome - Where the Coast gets engaged', // Site title.
  siteTitleAlt: 'Pav & Broome', // Alternative site title for SEO.
  siteLogo: '/icons/manifest-icon-512.png', // Logo used for SEO and manifest.
  siteUrl: 'https://pavandbroome.com', // Domain of your website without pathPrefix.
  pathPrefix: '', // Prefixes all links. For cases when deployed to example.github.io/gatsby-starter-business/.
  siteDescription: 'Fine Jewelry', // Website description used for RSS feeds/meta description tag.
  siteRss: '/rss.xml',
